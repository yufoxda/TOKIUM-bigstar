  ...
  return (
    <div className="w-80  px-3 h-full bg-gray-200 flex flex-col">
      ...
      <div className="h-full overflow-hidden">
        {(() => {
          const items = [];
          for (let i = 0; i < filteredKeihis.length; i++) {
            items.push(
              <button
                type="button"
                key={filteredKeihis[i].id}
                id={filteredKeihis[i].id}
                onClick={() => to_detail(filteredKeihis[i].id)}
              ...
              >
                <div className="w-full flex flex-col">
                  <div className="w-full flex flex-row">
                    <div className="w-1/3">{filteredKeihis[i].status}</div>
                    <div className="w-full right-0">
                      {formatCreatedAt(filteredKeihis[i].created_at)}
                    </div>
                  </div>
                  <div className="w-full flex flex-row">
                    <div className="w-1/3 truncate ">
                      {filteredKeihis[i].spend_to}
                    </div>
                    <div className="w-full right-0">
                      {calculateTotalAmount(
                        filteredKeihis[i].spend_request_item
                      )}
                      円
                    </div>
                  </div>
